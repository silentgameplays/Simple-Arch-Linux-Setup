...
* [multilib]
* Include = /etc/pacman.d/mirrorlist
# Update pacman configiuration
* sudo pacman -Syyuu
# Reinstall NVIDIA driver with proper libraries for proper video support
...
* cd yay
* makepkg -si
 # More dependencies and dxvk(DirectX to Vulkan API for Windows games) 
 ...
 * yay -S itch teamviewer
 ...
 # Enable teamviewer when you see scary messages
 * sudo systemctl enable teamviewerd.service
 * sudo systemctl start teamviewerd.service
